...
* Version versionable_tagging. Any version can have a versionable_tag attached to it (must be unique within the scope of the versioned parent) and that versionable_tag can be used for reversion.
  ...
  So if you're not big on version numbers, you could just versionable_tag your versions and avoid the numbers altogether.
